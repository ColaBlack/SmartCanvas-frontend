...
export async function genChartByAiUsingPost(
  ...
  return request<API.BaseResponseGenResultVO_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartAsyncByAi POST /api/chart/gen/async */
export async function genChartAsyncByAiUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartAsyncByAiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseGenResultVO_>('/api/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** getChartById GET /api/chart/get/id */
export async function getChartByIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartByIdUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseChartVO_>('/api/chart/get/id', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listChartByPageUsingPost(
  ...
  return request<API.BaseResponsePageChartVO_>('/api/chart/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
